...
class ClientMovieController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return view('client/hall', ['hallPick' => $hallPick, 'moviePick' => $moviePick, 'startTimePick' => $startTimePick, 'rowBd' => $rowBd, 'chairBd' => $chairBd, 'hallScheme' => $hallScheme, 'priceStandart' => $priceStandart, 'priceVip' => $priceVip]);
    }
